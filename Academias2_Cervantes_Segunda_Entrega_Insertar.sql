-- Los registos de las tablas de academias y nivel se hicieron a traves de un archivo de csv, en el documento de PDF explico el paso a paso --
...
-- importados de un archivo de csv --
